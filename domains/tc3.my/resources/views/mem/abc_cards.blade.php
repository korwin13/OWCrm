...
<script type="text/javascript">
    ...
    function showN(n) {
        current = n;
        document.card1.src='/assets/img/MemCards/Underside/Rus/' + alphabet[current] + '-1.jpg';
    }
    ...
    function showBack() {
        document.card1.src='/assets/img/MemCards/Card/Rus/' + alphabet[current] + '.jpg';
    }
    ...
    shortcut.add("Space", function() { showRandom(); });   
...
<div class="row">
    ...
    <div class="col-md-4">
        <a href="#" onMouseOut=showFront() 
            ...
            <img name="card1" src="\assets\img\MemCards\Underside\Rus\А-1.jpg" border="0" />
        </a>
    </div>    
    <div class="col-md-4"></div>    
</div>
    ...
    <div class="col-md-4">
         <div class="wrapper text-center">
             <div class="btn-group center-block" role="group" aria-label="...">
                       ...
                       <button type="button" class="btn btn-default" id="show10" onClick=show1()>01</button>
                       <button type="button" class="btn btn-default" id="show10" onClick=show10()>10</button>
                       <button type="button" class="btn btn-default" id="show20" onClick=show20()>20</button>
                       <button type="button" class="btn btn-default" id="showRandom" onclick=showRandom()>Random(30)</button>
             </div>
         </div>
    </div>    
    <div class="col-md-4"></div>    
